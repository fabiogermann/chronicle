package local.oss.chronicle.features.download
...
//            R.drawable.fetch_notification_cancel,
    ...
    companion object {
        const val DOWNLOAD_WORKER_ID: String =
            "local.oss.chronicle.features.download\$DOWNLOAD_WORKER_ID"
        const val DOWNLOAD_CHANNEL: String =
            "local.oss.chronicle.features.download\$DOWNLOAD_CHANNEL"
        const val KEY_BOOK_ID = "KEY_BOOK_ID"

        const val DOWNLOAD_NOTIF_GROUP =
            "local.oss.chronicle.features.download\$DOWNLOAD_NOTIF_GROUP"
        const val DOWNLOAD_NOTIF_SUMMARY_ID = 999

        const val DOWNLOADS_FINISHED_NOTIF_GROUP =
            "local.oss.chronicle.features.download\$DOWNLOADS_FINISHED_NOTIF_GROUP"
        const val DOWNLOADS_FINISHED_NOTIF_SUMMARY_ID = 1024

        const val ACTION_CANCEL_BOOK_DOWNLOAD =
            "local.oss.chronicle.features.download\$ACTION_CANCEL_BOOK_DOWNLOAD"
        const val ACTION_CANCEL_BOOK_DOWNLOAD_ID = 79211

        const val ACTION_CANCEL_ALL_DOWNLOADS =
            "local.oss.chronicle.features.download\$ACTION_CANCEL_ALL"
